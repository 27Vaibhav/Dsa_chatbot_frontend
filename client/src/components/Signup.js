      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center p-8 gap-12 relative z-10">
        ...
        >
          ...
          >
            ...
            >
              ...
              <div>class User {"{"}</div>
              <div className="pl-4">constructor(name, email) {"{"}</div>
              <div className="pl-8">this.name = name;</div>
              <div className="pl-8">this.email = email;</div>
              <div className="pl-8">this.level = "Beginner";</div>
        ...
        >
          ...
          >
            ...
            >
              Create an account to begin your algorithmic journey
            </motion.p>
            ...
            <form onSubmit={handleSignup}>
              ...
              >
                <label htmlFor="name" className="block mb-2 text-teal-300">
                  Full Name
                </label>
              ...
              {/* Hidden gender field to maintain compatibility with backend */}
              <input
                type="hidden"
                value={gender}
